...
import {
  buildMerkleProof,
  buildMerkleRoot,
} from "../utils/auditHash.js";
import {
  getPolygonAuditNetwork,
  isPolygonAuditConfigured,
  submitAnchorToPolygon,
} from "./polygonClient.js";

const buildBatchId = () =>
  `anchor_${new Date().toISOString().replace(/[:.]/g, "-")}`;
...
export const getWalletTransactionProof = async (
