...
router.post("/verification/identity", protect, verificationUpload.fields([
    { name: "documentFront", maxCount: 1 },
    { name: "documentBack", maxCount: 1 },
    { name: "selfie", maxCount: 1 },
]), submitIdentityVerification);
router.post("/verification/tutor", protect, verificationUpload.fields([{ name: "supportingDocument", maxCount: 1 }]), submitTutorVerification);
