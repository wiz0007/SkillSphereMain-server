...
router.post("/", protect, handleUpload(supportUpload.single("attachment")), createSupportConversation);
router.get("/:conversationId/messages", protect, getSupportMessages);
router.post("/:conversationId/messages", protect, handleUpload(supportUpload.single("attachment")), sendSupportMessage);
