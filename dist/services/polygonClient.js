...
const getPolygonEnv = () => ({
    ...
    contractAddress: process.env.POLYGON_AUDIT_CONTRACT_ADDRESS || "",
...
export const isPolygonAuditConfigured = () => {
    ...
    return Boolean(env.rpcUrl && env.privateKey && env.contractAddress);
};
export const submitAnchorToPolygon = async ({ batchId, rootHash, }) => {
    ...
    const contract = new ethers.Contract(contractAddress, auditAnchorAbi, signer);
